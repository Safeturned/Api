...
export const API_VERSION_V2 = 'v2.0';
...
export const API_ENDPOINTS = {
    FILES: `/${API_VERSION_V2}/files`,
    FILES_BY_HASH: (hash: string) => `/${API_VERSION_V2}/files/${hash}`,
    FILES_BY_FILENAME: (filename: string) => `/${API_VERSION_V2}/files/filename/${filename}`,
    FILES_ANALYTICS: `/${API_VERSION_V2}/files/analytics`,
