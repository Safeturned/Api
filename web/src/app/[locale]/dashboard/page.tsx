        ...
        <div className='min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 text-white'>
            ...
            <div className='max-w-7xl mx-auto px-6 py-12'>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-4 md:gap-6 mb-10'>
                    ...
                    <Link
                        href='/discord'
                        className='bg-slate-800/40 backdrop-blur-md border border-indigo-500/20 rounded-xl p-5 hover:border-indigo-400/50 transition-all duration-200 group'
                    >
                        <div className='flex items-center justify-between mb-3'>
                            <div className='w-10 h-10 bg-indigo-600/80 rounded-lg flex items-center justify-center'>
                                <svg
                                    className='w-5 h-5'
                                    viewBox='0 0 24 24'
                                    fill='currentColor'
                        ...
                        <h3 className='font-bold text-white mb-1 group-hover:text-indigo-300 transition-colors'>
                            {t('dashboard.discordBot')}
                        </h3>
                        <p className='text-gray-400 text-sm leading-relaxed'>
                            {t('dashboard.discordBotDesc')}
                        </p>
                    </Link>
