...
export default function Page() {
    ...
    return (
        <div className='min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 text-white relative'>
            ...
            <section id='integrations' className='px-6 py-16 md:py-24 bg-slate-800/10'>
                <div className='max-w-6xl mx-auto'>
                    ...
                    <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8'>
                        <Link
                            href='/discord'
                            className='bg-slate-800/50 backdrop-blur-sm border border-indigo-500/30 rounded-lg p-6 md:p-8 hover:bg-slate-800/70 hover:border-indigo-400/50 transition-all duration-200 group'
                        >
                            ...
                            <h3 className='text-lg md:text-xl font-semibold mb-3 text-white'>
                                {t('integrations.discord.title')}
                            </h3>
                            <p className='text-gray-300 text-sm md:text-base leading-relaxed mb-4'>
                                {t('integrations.discord.description')}
                            </p>
                            <span className='inline-flex items-center gap-2 text-indigo-400 group-hover:text-indigo-300 font-medium'>
                                {t('integrations.discord.cta')}
                                <svg
                        ...
                        <Link
                            ...
                            className='bg-slate-800/50 backdrop-blur-sm border border-cyan-500/30 rounded-lg p-6 md:p-8 hover:bg-slate-800/70 hover:border-cyan-400/50 transition-all duration-200 group'
                        >
                        ...
                        <Link
                            href='/docs'
                            className='bg-slate-800/50 backdrop-blur-sm border border-purple-500/30 rounded-lg p-6 md:p-8 hover:bg-slate-800/70 hover:border-purple-400/50 transition-all duration-200 group'
                        >
                            <div className='w-12 h-12 bg-purple-600 rounded-lg flex items-center justify-center mb-4'>
                                <svg
                                    className='w-6 h-6'
