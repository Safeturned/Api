...
namespace Safeturned.Api.Migrations
{
    ...
    [Migration("20260107113506_RevampPermissionsAndQueuedAnalysis")]
    partial class RevampPermissionsAndQueuedAnalysis
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Safeturned.Api.Database.Models.LoaderRelease", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("Framework", "Configuration", "IsLatest");

                    b.HasIndex("Framework", "Configuration", "Version")
                        .IsUnique();

                    b.ToTable("LoaderReleases");
                });

            modelBuilder.Entity("Safeturned.Api.Database.Models.PluginInstallerRelease", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("Framework", "IsLatest");

                    b.HasIndex("Framework", "Version")
                        .IsUnique();

                    b.ToTable("PluginInstallerReleases");
                });

            modelBuilder.Entity("Safeturned.Api.Database.Models.PluginRelease", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
