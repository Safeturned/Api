...
{
    var keyDirectory = new DirectoryInfo(dataProtectionKeyPath);
    keyDirectory.Create();
    services.AddDataProtection()
        .PersistKeysToFileSystem(keyDirectory);
    logger.Information("Data Protection keys will be persisted to: {KeyPath}", dataProtectionKeyPath);
}
else
{
...
using (var scope = app.Services.CreateScope())
{
    ...
    var officialBadgeSeedService = new OfficialBadgeSeed(context, logger, config);
    officialBadgeSeedService.SeedOfficialBadges();
}
