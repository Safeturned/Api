...
public class TokenService : ITokenService
{
    ...
    public string GenerateAccessToken(User user)
    {
        ...
        var expirationMinutes = _config.GetValue<int?>("Jwt:ExpirationMinutes") ?? 525600; // 1 year in minutes
    ...
    public async Task<RefreshToken> GenerateRefreshTokenAsync(User user, string ipAddress)
    {
        var refreshToken = new RefreshToken
        {
            ...
            ExpiresAt = DateTime.UtcNow.AddYears(1), // Refresh tokens valid for 1 year
